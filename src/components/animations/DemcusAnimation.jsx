...
const DemcusAnimation = () => {
  ...
  return (
    <div className="w-full h-48 flex flex-col items-center justify-center">
      ...
      <motion.div 
        className="w-22 h-10 bg-gradient-to-r from-purple-700 to-indigo-900 rounded-md flex items-center justify-center mb-4 relative"
      ...
      <div className="w-full flex justify-between">
        {separatedWaves.map((wave, index) => (
          ...
          >
            <div className="text-[8px] text-white opacity-50 absolute top-6 left-5">Speaker {index + 1}</div>
